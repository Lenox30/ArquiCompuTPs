...
- Diseño de componentes digitales (en Verilog/TCL)  
- Simulación de comportamientos  
- Restricciones de síntesis (constraints)  

El objetivo es consolidar los distintos entregables de la materia en un solo lugar, facilitar revisión, versionado y reutilización.
